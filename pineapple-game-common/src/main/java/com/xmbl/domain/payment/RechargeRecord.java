package com.xmbl.domain.payment;

import com.xmbl.mongodb.pojo.GeneralBean;
import lombok.Data;

import java.util.Date;

/**
 * Copyright © 2017 noseparte(Libra) © Like the wind, like rain @Author Noseparte @Compile
 * 2017年10月2日 -- 下午11:34:27 @Version 1.0 @Description 平台订单充值记录
 */
@Data
